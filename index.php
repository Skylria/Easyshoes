    ...
    <div id="page-top">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">Sobre a EasyShoes</a></li>
              <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#services">Nossos Serviços</a></li>
              <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#contact">Sobre Nós</a></li>
              <li class="nav-item"><a class="nav-link js-scroll-trigger" href="produtos.php">Nossos Produtos</a></li>
              <li class="nav-item"><a class="nav-link js-scroll-trigger" href="login.php">Login (funcionários)</a></li>
            </ul>
          </div>
        </div>
      </nav>
      ...
      <section id="contact">
        ...
        <div align="center">
          ...
          <a href="https://www.facebook.com/"><i class="fa fa-4x fa-facebook-official" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
          <a href="https://web.whatsapp.com/"><i class="fa fa-4x fa-whatsapp" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
          <a href="https://twitter.com/login?lang=pt"><i class="fa fa-4x fa-twitter" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
          <a href="https://www.google.com/gmail/"><i class="fa fa-4x fa-google-plus-official" aria-hidden="true"></i>
          </a><br>
        </div>
      </section>
